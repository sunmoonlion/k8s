...
# 从 generate-app/ -> app/ -> custom-values/ -> k8s-resource/ -> resources/ -> incubator-app-backend/
...
export INCUBATOR_BFF_IMAGE_REGISTRY="${INCUBATOR_BFF_IMAGE_REGISTRY:-}"
export INCUBATOR_BFF_IMAGE_PROJECT="${INCUBATOR_BFF_IMAGE_PROJECT:-}"
...
export INCUBATOR_BFF_IMAGE_PULL_SECRET_NAME="${INCUBATOR_BFF_IMAGE_PULL_SECRET_NAME:-}"
export INCUBATOR_BFF_SECRET_NAME="${INCUBATOR_BFF_SECRET_NAME:-}"
export INCUBATOR_BFF_CONFIGMAP_NAME="${INCUBATOR_BFF_CONFIGMAP_NAME:-}"
