...
⚠ **不得把 Codex 默认 accept 当任何一档批准**（`client.py:773-779`，见 [§2.7](../../0002-agent-execution/composition/agent-dev-guide.md)），
...
| 派活前先建好各自的 worktree 和命名分支 | 多个执行者写同一工作区，后写覆盖先写（[§3.6](../../0002-agent-execution/composition/agent-dev-guide.md)） |
