...
- 子任务目录名是「四位号-短名」，在同一个 `modules/` 里从 `0001` 起编号；本目录是项目本身，不编号。见 [`thread-numbering.md`](thread-numbering.md)。
...
| 每次派工的任务书 | 各 turn 的 `user-message.md`，如 [`thread/0001-none/user-message.md`](thread/0001-sdd-none/0001-none/user-message.md) |
| thread、turn 与模块怎么编号 | [`thread-numbering.md`](thread-numbering.md) |
