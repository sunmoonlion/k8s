#!/bin/bash
# research-admin-frontend PVC YAML 生成脚本

set -euo pipefail

SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
CONFIG_FILE="$SCRIPT_DIR/generate-research-admin-frontend-pvc.conf"
...
main() {
    log_info "开始生成 research-admin-frontend PVC YAML 文件..."
