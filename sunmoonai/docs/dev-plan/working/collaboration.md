...
> 属于智能体的运作纪律，见 [`../agent-discipline.md`](../agent-discipline.md)。
...
给每路独立进程与独立 `CODEX_HOME`，隔离由机制保证（见 [`../agent-discipline.md`](../agent-discipline.md) §3.1）。
...
| 坑 | 说明 |
| --- | --- |
| 提案阶段泄露了别人的方案 | 得到的是趋同不是独立信号，等于白问（见 [`../agent-discipline.md`](../agent-discipline.md) §2） |
