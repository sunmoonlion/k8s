#!/bin/bash
# toutiao-app-front ConfigMap YAML 生成脚本

set -euo pipefail

SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
CONFIG_FILE="$SCRIPT_DIR/generate-toutiao-app-front-config.conf"
...
export TOUTIAO_API_URL="${TOUTIAO_API_URL:-}"
...
main() {
    log_info "开始生成 toutiao-app-front ConfigMap YAML..."
