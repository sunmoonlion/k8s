...
```bash
chmod +x /home/zym/k8s/utils/db-provisioner/bin/dbctl
chmod +x /home/zym/k8s/utils/db-provisioner/bin/init-service-provision-template.sh
```

### 初始化“组件模板项目”（推荐）

```bash
/home/zym/k8s/utils/db-provisioner/bin/init-service-provision-template.sh \
...
```bash
/home/zym/k8s/utils/db-provisioner/bin/dbctl \
  --config /home/zym/k8s/utils/db-provisioner/examples/mongodb-k8s.env \
  --target k8s
```
...
```bash
/home/zym/k8s/utils/db-provisioner/bin/dbctl \
  --config /home/zym/k8s/utils/db-provisioner/examples/postgresql-external.env \
  --target external
```
...
```bash
/home/zym/k8s/utils/db-provisioner/bin/dbctl \
  --config /home/zym/k8s/utils/db-provisioner/examples/postgresql-k8s.env \
  --target k8s
```
...
```bash
/home/zym/k8s/utils/db-provisioner/bin/dbctl \
  --config /home/zym/k8s/utils/db-provisioner/examples/redis-k8s.env \
  --dry-run
```
