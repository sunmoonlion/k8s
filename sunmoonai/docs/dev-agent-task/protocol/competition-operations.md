...
只在工单判为 T2 时使用；T0/T1 按 [§3.4](../SDD/modules/0001-backend/SDD/agent-dev-guide.md) 执行。协议仍是流程真源，
...
| ⑦ 清理发布 | 指定单写者按 [§3.15](../SDD/modules/0001-backend/SDD/modules/0004-acceptance-commit/SDD/agent-dev-guide.md)–[§3.16](../SDD/modules/0001-backend/SDD/modules/0004-acceptance-commit/SDD/agent-dev-guide.md) 收存证据、清理本次私有产物，再发布 | 目标版本比较通过、批准仍有效；只清理获准对象，不清空他家工作区 |
