...
> 源码复核：2026-09-13 ｜ 相关规则见 [`../../dev-agent-standards/constraints.md`](../../dev-agent-standards/constraints.md)「数据」D1–D9
...
见 [`../../dev-agent-standards/constraints.md`](../../dev-agent-standards/constraints.md)「数据」。
