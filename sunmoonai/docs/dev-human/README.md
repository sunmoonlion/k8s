...
**我们怎么共事**——派工、定稿、批准、验收、多方竞争。**新人先读这里**，再读
[`../dev-agent/`](../dev-agent/)（要建什么）。改这里的规矩，代码不用跟着改。
...
| [`lifecycle.md`](lifecycle.md) | **开发的生命周期**：一问从人发出到人拿到答的**七站**。产品那条请求往返是**九站**（[见那边](../dev-agent/SDD/architecture/lifecycle.md)）——多出来的是**传递**，人当面说就不需要 |
