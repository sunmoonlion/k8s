...
APPLICATION="sunmoonai-knowledge-web-p0-009c"
REDIRECT_URI="https://knowledge-web-p0-009c.sunmoonai.com:30443/api/auth/callback"
MODE="plan"
...
[[ "$REDIRECT_URI" =~ ^https://knowledge-web-p0-009c\.sunmoonai\.com(:[0-9]+)?/api/auth/callback$ ]] || {
