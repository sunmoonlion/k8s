...
- 结构决策（用户确认）：基线 1 份 + handoff 1 份 + 按 App 施工清单 4 份
  （info / knowledge / investment / platform），落 `k8s/sunmoonai/docs/mooc-manus-v6/`。
  v5 的 Phase 0 历史不再保留任务编号，只作"既成现状"一节交代。

## ③ 落地去向

- v6 基线：`k8s/sunmoonai/docs/mooc-manus-v6/v6-longterm-baseline.md`（待写）
- v6 handoff：`k8s/sunmoonai/docs/mooc-manus-v6/v6-handoff.md`（待写）
- v6 施工清单：`k8s/sunmoonai/docs/mooc-manus-v6/v6-plan-{info,knowledge,investment,platform}.md`（待写）
