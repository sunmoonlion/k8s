...
# =============================================================================
# Harbor Registry Secret 部署脚本（Investment Admin Backend）
...
# deploy-harbor-registry-secret/ -> harbor-registry-secret/ -> secret/ -> deploy-investment-admin-backend/ -> investment-admin-backend/
...
main() {
    ...
    log_info "部署 Harbor Registry Secret (Investment Admin Backend)..."
    log_info "部署参数："
    log_info "  - 操作: $action"
    ...
    echo ""
    log_success "Harbor Registry Secret (Investment Admin Backend) 操作完成！"
    log_info "操作信息："
    log_info "  - 操作: $action"
...
# 显示帮助信息
show_help() {
    echo "Harbor Registry Secret 部署脚本 (Investment Admin Backend)"
    echo ""
    echo "用法:"
