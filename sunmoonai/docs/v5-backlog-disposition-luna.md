...
| B7 已有覆盖收口 | B7a 源码已集成；B7b 待核验 | [公共日志证据](v5-backlog-logging-luna.md)：四仓 855 项、零跳过，两端 master/Luna 同步；B7b 逐验收子项核投递、身份/配置、运维指标、归档、健康与恢复；接 B4 对账周期/权限/保留策略、B5 真实映射/旧任务/一致配置切换、B6 旧协议调查/排空/回滚；自动修复回收与全引用门禁交 N4；未验证项不销账 |
