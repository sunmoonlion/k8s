...
CONFIG_FILE="$SCRIPT_DIR/deploy-cw-inc-ns.conf"
# 计算项目根目录（应用根目录）
...
NAMESPACE_YAML="$K8S_RESOURCE_DIR/custom-values/namespace/cw-inc-ns/generate-cw-inc-ns/celeryworker-incubator-namespace-generated.yaml"
...
main() {
  ...
  local generate_script="$PROJECT_ROOT/resources/k8s-resource/custom-values/namespace/cw-inc-ns/generate-cw-inc-ns/generate-cw-inc-ns.sh"
