...
> 更新：2026-09-20，本机 KIND 已切换固定开发候选及独立运行身份 ｜ 相关规则见 [`../../dev-agent/SDD/constraints.md`](../../dev-agent/SDD/constraints.md)「发布」R1–R7
...
**动发布、清镜像前**，先读 [`../../dev-agent/composition/constraints.md`](../../dev-agent/SDD/constraints.md)「发布」——本页只写现状。
