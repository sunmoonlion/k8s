...
run_db_access_bootstrap() {
    ...
    local source_root="${INVESTMENT_WEB_BACKEND_SOURCE_ROOT:-/home/zymun/investment-app/investment-web-backend}"
    ...
    log_info "开始执行 Investment Web Backend DB bootstrap..."
