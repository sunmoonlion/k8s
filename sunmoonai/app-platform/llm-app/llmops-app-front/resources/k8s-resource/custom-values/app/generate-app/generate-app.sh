...
# 从 generate-app/ -> app/ -> custom-values/ -> k8s-resource/ -> resources/ -> llmops-app-front/
...
export LLMOPS_SSR_IMAGE_REGISTRY="${LLMOPS_SSR_IMAGE_REGISTRY:-}"
export LLMOPS_SSR_IMAGE_PROJECT="${LLMOPS_SSR_IMAGE_PROJECT:-}"
...
export LLMOPS_SSR_IMAGE_PULL_SECRET_NAME="${LLMOPS_SSR_IMAGE_PULL_SECRET_NAME:-}"
export LLMOPS_SSR_SECRET_NAME="${LLMOPS_SSR_SECRET_NAME:-}"
export LLMOPS_SSR_CONFIGMAP_NAME="${LLMOPS_SSR_CONFIGMAP_NAME:-}"
