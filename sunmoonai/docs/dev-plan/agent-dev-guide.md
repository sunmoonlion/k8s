...
> - 第 2 步：「执行者的共同纪律」写进 [dev-agent-guide 总则](../dev-agent-guide/README.md)；「检查本身也必须接受检查」与「没查什么」的通用部分写进 [`dev-agent-guide/deliverables/uat`](../dev-agent-guide/deliverables/uat/README.md)
>
