...
>
> 2026-09-15：§3.19、§3.21 已随 protocol 移到 [`dev-agent-standards/deliverables/sdd/protocol/round-operations.md`](../../../../../dev-agent-standards/deliverables/sdd/protocol/round-operations.md)。
