...
> 取证时点：2026-09-13 源码及发布边界复核 ｜ 相关规则见 [`../../dev-agent-standards/constraints.md`](../../dev-agent-standards/constraints.md)「发布」R1–R7
...
**动发布、清镜像前**，先读 [`../../dev-agent-standards/constraints.md`](../../dev-agent-standards/constraints.md)「发布」——本页只写现状。
