#!/bin/bash
# Document Converter BFF YAML 生成脚本
# 根据配置生成应用的 YAML 文件
...
# 从 generate-app/ -> app/ -> custom-values/ -> k8s-resource/ -> resources/ -> document-converter-backend/
...
MAIN_DEPLOY_CONFIG="$PROJECT_ROOT/deploy-document-converter-backend/app/deploy-app/deploy-document-converter-backend.conf"
...
export DOCUMENT_CONVERTER_IMAGE_REGISTRY="${DOCUMENT_CONVERTER_IMAGE_REGISTRY:-}"
export DOCUMENT_CONVERTER_IMAGE_PROJECT="${DOCUMENT_CONVERTER_IMAGE_PROJECT:-}"
export DOCUMENT_CONVERTER_IMAGE="${DOCUMENT_CONVERTER_IMAGE:-}"
export DOCUMENT_CONVERTER_TAG="${DOCUMENT_CONVERTER_TAG:-}"
export DOCUMENT_CONVERTER_FULL_IMAGE_NAME="${DOCUMENT_CONVERTER_IMAGE_REGISTRY}/${DOCUMENT_CONVERTER_IMAGE_PROJECT}/${DOCUMENT_CONVERTER_IMAGE}:${DOCUMENT_CONVERTER_TAG}"
export IMAGE_PULL_POLICY="${IMAGE_PULL_POLICY:-}"
export DOCUMENT_CONVERTER_IMAGE_PULL_SECRET_NAME="${DOCUMENT_CONVERTER_IMAGE_PULL_SECRET_NAME:-}"
export DOCUMENT_CONVERTER_SECRET_NAME="${DOCUMENT_CONVERTER_SECRET_NAME:-}"
export DOCUMENT_CONVERTER_CONFIGMAP_NAME="${DOCUMENT_CONVERTER_CONFIGMAP_NAME:-}"
export DOCUMENT_CONVERTER_REPLICAS="${DOCUMENT_CONVERTER_REPLICAS:-}"
export DOCUMENT_CONVERTER_CPU_REQUEST="${DOCUMENT_CONVERTER_CPU_REQUEST:-}"
export DOCUMENT_CONVERTER_CPU_LIMIT="${DOCUMENT_CONVERTER_CPU_LIMIT:-}"
export DOCUMENT_CONVERTER_MEMORY_REQUEST="${DOCUMENT_CONVERTER_MEMORY_REQUEST:-}"
export DOCUMENT_CONVERTER_MEMORY_LIMIT="${DOCUMENT_CONVERTER_MEMORY_LIMIT:-}"
export DOCUMENT_CONVERTER_SERVICE_PORT="${DOCUMENT_CONVERTER_SERVICE_PORT:-}"
...
# 生成 YAML
main() {
    log_info "开始生成 Document Converter BFF YAML 文件..."
