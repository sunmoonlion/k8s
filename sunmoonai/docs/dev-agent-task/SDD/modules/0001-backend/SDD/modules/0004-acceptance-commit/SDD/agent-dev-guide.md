...
> 依据的通用规范：[UAT「判据与完成」](../../../../../../../../dev-agent-standards/uat/uat-rules.md)
...
> 依据的通用规范：[UAT「完成判据」](../../../../../../../../dev-agent-standards/uat/uat-rules.md)
...
> 依据的通用规范：[UAT「验证分层」](../../../../../../../../dev-agent-standards/uat/uat-rules.md)
...
> 依据的通用规范：[UAT「证据账按流程分级」](../../../../../../../../dev-agent-standards/uat/uat-rules.md)
...
> 依据的通用规范：[UAT「先裁决事实，再谈偏好」](../../../../../../../../dev-agent-standards/uat/uat-rules.md)
...
> 依据的通用规范：[UAT「检查本身也必须接受检查」](../../../../../../../../dev-agent-standards/uat/uat-rules.md)
...
> 依据的通用规范：[UAT「覆盖声明」](../../../../../../../../dev-agent-standards/uat/uat-rules.md)
...
> 依据的通用规范：[UAT「检查给出假答案的边界案例」](../../../../../../../../dev-agent-standards/uat/uat-rules.md)
...
> 依据的通用规范：[UAT「评审的收益与盲区」](../../../../../../../../dev-agent-standards/uat/uat-rules.md)
