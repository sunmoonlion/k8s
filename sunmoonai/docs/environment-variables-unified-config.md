...
已创建：`~/master/k8s/sunmoonai/configmaps/environment-configmap.yaml`
...
已创建：`~/master/k8s/sunmoonai/secrets/environment-secret.yaml.example`
...
3. **在 Deployment 中引用**：
   见 `~/master/k8s/sunmoonai/docs/environment-variables-k8s-deployment.md`
