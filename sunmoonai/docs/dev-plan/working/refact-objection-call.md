...
| **截止** | **2026-09-04 19:00**。逾期视为**弃权**，流程继续，处置记录写「未响应」——**不写成「认可」** |
...
| 环节 | 截止 | 逾期后果 |
| --- | --- | --- |
| ④ 异议 | 2026-09-04 19:00 | 视为**弃权**，流程继续。④ 之后还有 ⑤ 验收与 ⑥ 人确认两道独立检查，故此处允许默认放行 |
| ⑤ 验收 | 开始时在验收通知里给出 | 验收方视为**不可用**，按顺位换人。**⑤ 不设默认通过**——最后的检查不允许超时放行 |
| ⑥ 确认 | 无 | **不设逾期默认。**人不确认就不发布 |
