...
```bash
cd ~/master/k8s/sunmoonai/document-converter-app/document-converter-backend/resources/source
...
```bash
cd ~/master/k8s/sunmoonai/document-converter-app/document-converter-backend/deploy-document-converter-backend/app/deploy-app
./deploy-document-converter-backend.sh --cluster C2
```
...
`deploy-document-converter-backend/deploy-document-converter.conf`
...
**配置方式**：
在 `deploy-document-converter-backend/deploy-document-converter.conf` 中设置：
```bash
...
├── deploy-document-converter-backend/    # 部署配置
...
# 3. 更新配置
vim deploy-document-converter-backend/deploy-document-converter.conf
