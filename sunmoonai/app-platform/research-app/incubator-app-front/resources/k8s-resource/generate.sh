...
SECRET_CONFIG="../../deploy-incubator-front/secrets/incubator-app-front-secret/deploy-incubator-app-front-secret/deploy-incubator-app-front-secret.conf"
...
export INCUBATOR_SSR_UNIFIED_HOST="${INCUBATOR_SSR_UNIFIED_HOST:-incubator-front.sunmoonai.com}"
...
export SERVICE_NAME="${SERVICE_NAME:-incubator-app-front}"
...
# 注意：这些变量的默认值在 deploy-incubator-front.conf 中配置
export PVC_NAME="${PVC_NAME:-incubator-app-front-pvc}"
