...
export AUTH_APP_SSR_IMAGE_REGISTRY="${AUTH_APP_SSR_IMAGE_REGISTRY:-harbor.sunmoonai.com}"
...
HARBOR_DOCKER_SERVER="${HARBOR_DOCKER_SERVER:-${AUTH_APP_SSR_IMAGE_REGISTRY:-harbor.sunmoonai.com}}"
