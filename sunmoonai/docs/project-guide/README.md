...
| **动代码前必读的规则** | [`../dev-agent-standards/constraints.md`](../dev-agent-standards/constraints.md)（39 条，按主题分组） |
| 让多个助手/智能体对同一需求各出方案、审核、吸收 | [`../dev-agent-standards/protocol/round-protocol.md`](../dev-agent-standards/protocol/round-protocol.md) |
| 推送改动、跨机拉取、子模块的坑 | `~/five-repos-sync/sync-five-repos.sh`；规则见 [`../dev-agent-standards/constraints.md`](../dev-agent-standards/constraints.md) T4 |
