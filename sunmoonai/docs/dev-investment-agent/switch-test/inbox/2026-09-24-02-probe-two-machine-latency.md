...
```text
跑：RELAY=ws://43.153.135.74:47100 USER_ID=local DURATION=600 bash runtime/scripts/probe-two-machine-latency.sh
...
回传：runtime/scripts/results/probe-two-machine-latency.<时间>.txt；提交并 git push origin fable
```
