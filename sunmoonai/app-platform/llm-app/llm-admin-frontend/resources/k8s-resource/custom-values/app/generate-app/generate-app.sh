...
# 从 generate-app/ -> app/ -> custom-values/ -> k8s-resource/ -> resources/ -> llm-admin-frontend/
...
export LLM_ADMIN_FRONTEND_IMAGE_REGISTRY="${LLM_ADMIN_FRONTEND_IMAGE_REGISTRY:-}"
export LLM_ADMIN_FRONTEND_IMAGE_PROJECT="${LLM_ADMIN_FRONTEND_IMAGE_PROJECT:-}"
export LLM_ADMIN_FRONTEND_IMAGE="${LLM_ADMIN_FRONTEND_IMAGE:-}"
export LLM_ADMIN_FRONTEND_TAG="${LLM_ADMIN_FRONTEND_TAG:-}"
export LLM_ADMIN_FRONTEND_FULL_IMAGE_NAME="${LLM_ADMIN_FRONTEND_IMAGE_REGISTRY}/${LLM_ADMIN_FRONTEND_IMAGE_PROJECT}/${LLM_ADMIN_FRONTEND_IMAGE}:${LLM_ADMIN_FRONTEND_TAG}"
export IMAGE_PULL_POLICY="${IMAGE_PULL_POLICY:-}"
export LLM_ADMIN_FRONTEND_IMAGE_PULL_SECRET_NAME="${LLM_ADMIN_FRONTEND_IMAGE_PULL_SECRET_NAME:-}"
export LLM_ADMIN_FRONTEND_SECRET_NAME="${LLM_ADMIN_FRONTEND_SECRET_NAME:-}"
export LLM_ADMIN_FRONTEND_CONFIGMAP_NAME="${LLM_ADMIN_FRONTEND_CONFIGMAP_NAME:-}"
...
# 生成 YAML
main() {
    log_info "开始生成 Llm Admin Frontend YAML 文件..."
