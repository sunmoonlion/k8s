...
# deploy-harbor-registry-secret/ -> harbor-registry-secret/ -> secret/ -> deploy-document-converter-bff/ -> document-converter-bff/
...
main() {
  ...
  case "$action" in
    ...
    status)
      ...
      local secret_name="harbor-registry-secret"
