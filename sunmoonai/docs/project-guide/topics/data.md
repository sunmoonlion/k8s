...
> 源码复核：2026-09-13 ｜ 相关规则见 [`../../dev-agent/composition/constraints.md`](../../dev-agent/rules/constraints.md)「数据」D1–D9
...
见 [`../../dev-agent/composition/constraints.md`](../../dev-agent/rules/constraints.md)「数据」。
