#!/bin/bash
# nodebullworker-llm-web-backend Deployment YAML 生成脚本
...
# 从 generate-app/ -> app/ -> custom-values/ -> k8s-resource/ -> resources/ -> nodebullworker-llm-web-backend/
...
export NODEBULLWORKER_LLM_WEB_BACKEND_IMAGE_REGISTRY="${NODEBULLWORKER_LLM_WEB_BACKEND_IMAGE_REGISTRY:-}"
export NODEBULLWORKER_LLM_WEB_BACKEND_IMAGE_PROJECT="${NODEBULLWORKER_LLM_WEB_BACKEND_IMAGE_PROJECT:-}"
export NODEBULLWORKER_LLM_WEB_BACKEND_IMAGE="${NODEBULLWORKER_LLM_WEB_BACKEND_IMAGE:-}"
export NODEBULLWORKER_LLM_WEB_BACKEND_TAG="${NODEBULLWORKER_LLM_WEB_BACKEND_TAG:-}"
...
export NODEBULLWORKER_LLM_WEB_BACKEND_IMAGE_PULL_SECRET_NAME="${NODEBULLWORKER_LLM_WEB_BACKEND_IMAGE_PULL_SECRET_NAME:-}"
export NODEBULLWORKER_LLM_WEB_BACKEND_SECRET_NAME="${NODEBULLWORKER_LLM_WEB_BACKEND_SECRET_NAME:-}"
export NODEBULLWORKER_LLM_WEB_BACKEND_CONFIGMAP_NAME="${NODEBULLWORKER_LLM_WEB_BACKEND_CONFIGMAP_NAME:-}"
export NODEBULLWORKER_LLM_WEB_BACKEND_QUEUE_REDIS_SECRET_NAME="${NODEBULLWORKER_LLM_WEB_BACKEND_QUEUE_REDIS_SECRET_NAME:-}"
...
main() {
    log_info "开始生成 nodebullworker-llm-web-backend YAML 文件..."
