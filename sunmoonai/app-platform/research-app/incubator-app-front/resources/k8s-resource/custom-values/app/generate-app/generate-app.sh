...
# 从 generate-app/ -> app/ -> custom-values/ -> k8s-resource/ -> resources/ -> incubator-app-front/
...
export INCUBATOR_SSR_IMAGE_REGISTRY="${INCUBATOR_SSR_IMAGE_REGISTRY:-}"
export INCUBATOR_SSR_IMAGE_PROJECT="${INCUBATOR_SSR_IMAGE_PROJECT:-}"
...
export INCUBATOR_SSR_IMAGE_PULL_SECRET_NAME="${INCUBATOR_SSR_IMAGE_PULL_SECRET_NAME:-}"
export INCUBATOR_SSR_SECRET_NAME="${INCUBATOR_SSR_SECRET_NAME:-}"
export INCUBATOR_SSR_CONFIGMAP_NAME="${INCUBATOR_SSR_CONFIGMAP_NAME:-}"
