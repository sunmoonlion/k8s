...
# 从 deploy-ingress/ -> celeryworker-incubator-ingress/ -> ingress/ -> deploy-celeryworker-incubator/ -> celeryworker-incubator/
...
INGRESS_FILE="${K8S_RESOURCE_DIR}/custom-values/ingress/celeryworker-incubator-ingress/generate-ingress/celeryworker-incubator-ingress-generated.yaml"
...
load_config() {
    ...
    # 主配置文件路径：../../../app/deploy-app/deploy-celeryworker-incubator.conf（相对于当前脚本目录）
    local main_config_file="$(cd "$SCRIPT_DIR/../../../app/deploy-app" && pwd)/deploy-celeryworker-incubator.conf"
