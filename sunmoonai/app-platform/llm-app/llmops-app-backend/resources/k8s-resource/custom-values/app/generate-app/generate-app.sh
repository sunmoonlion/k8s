...
# 从 generate-app/ -> app/ -> custom-values/ -> k8s-resource/ -> resources/ -> llmops-app-backend/
...
export LLMOPS_BFF_IMAGE_REGISTRY="${LLMOPS_BFF_IMAGE_REGISTRY:-}"
export LLMOPS_BFF_IMAGE_PROJECT="${LLMOPS_BFF_IMAGE_PROJECT:-}"
export LLMOPS_BFF_IMAGE="${LLMOPS_BFF_IMAGE:-}"
export LLMOPS_BFF_TAG="${LLMOPS_BFF_TAG:-}"
...
export LLMOPS_BFF_IMAGE_PULL_SECRET_NAME="${LLMOPS_BFF_IMAGE_PULL_SECRET_NAME:-}"
export LLMOPS_BFF_SECRET_NAME="${LLMOPS_BFF_SECRET_NAME:-}"
export LLMOPS_BFF_CONFIGMAP_NAME="${LLMOPS_BFF_CONFIGMAP_NAME:-}"
...
# 生成 YAML
main() {
    log_info "开始生成 LLMOps App BFF YAML 文件..."
