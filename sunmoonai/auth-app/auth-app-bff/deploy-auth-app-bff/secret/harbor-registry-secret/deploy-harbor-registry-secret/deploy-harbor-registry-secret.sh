...
# deploy-harbor-registry-secret/ -> harbor-registry-secret/ -> secret/ -> deploy-auth-app-bff/ -> auth-app-bff/
...
# 主配置文件路径：../../deploy-auth-app-bff.conf（相对于当前脚本目录）
MAIN_CONFIG_FILE="$(cd "$SCRIPT_DIR/../../.." && pwd)/deploy-auth-app-bff.conf"
