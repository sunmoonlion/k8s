...
CONFIG_FILE="$SCRIPT_DIR/generate-document-converter-secret.conf"
...
# 从 generate-document-converter-secret/ -> document-converter-secret/ -> secret/ -> custom-values/ -> k8s-resource/ -> resources/ -> document-converter-bff/
