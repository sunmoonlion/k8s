...
# 2. 重新部署 Secret
cd /home/zym/k8s/sunmoonai/cicd-platform/jenkins/deploy-jenkins/secrets/jenkins-sunmoonai/deploy-jenkins-sunmoonai
...
```bash
# 使用提供的清理脚本
cd /home/zym/k8s/sunmoonai/cicd-platform/jenkins
./cleanup-jenkins.sh
