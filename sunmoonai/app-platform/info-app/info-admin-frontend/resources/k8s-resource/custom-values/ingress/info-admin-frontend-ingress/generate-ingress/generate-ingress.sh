#!/bin/bash
# info-admin-frontend Ingress YAML 生成脚本
...
export API_SERVICE_NAME="${API_SERVICE_NAME:-}"
export API_SERVICE_PORT="${API_SERVICE_PORT:-}"
...
main() {
    log_info "开始生成 info-admin-frontend Ingress YAML 文件..."
