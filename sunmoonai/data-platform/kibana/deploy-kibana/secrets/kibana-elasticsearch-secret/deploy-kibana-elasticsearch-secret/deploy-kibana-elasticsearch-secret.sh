...
# =============================================================================
# Kibana Elasticsearch Secret 部署脚本
# 文件名: deploy-kibana-elasticsearch-secret.sh
# 用途: 生成并部署Kibana连接Elasticsearch的认证Secret到Kubernetes集群
# =============================================================================
...
CONFIG_FILE="$SCRIPT_DIR/deploy-kibana-elasticsearch-secret.conf"
...
main() {
    ...
    log_info "部署 Kibana Elasticsearch Secret..."
    ...
    local secret_yaml="$SECRET_DIR/kibana-elasticsearch-secret.yaml"
    ...
    log_success "Kibana Elasticsearch Secret 部署完成！"
}
