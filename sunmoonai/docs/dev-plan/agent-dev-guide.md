...
> - 第 2 步：「执行者的共同纪律」写进 [dev-agent-standards 总则](../dev-agent-standards/README.md)；「检查本身也必须接受检查」与「没查什么」的通用部分写进 [`dev-agent-standards/deliverables/uat`](../dev-agent-standards/deliverables/uat/README.md)
>
