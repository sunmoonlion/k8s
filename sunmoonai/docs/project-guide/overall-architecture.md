...
**架构讨论已经结束**，目标态定在 [需求](../dev-agent/PRD/requirement.md) 与
...
产品留白先查[需求](../dev-agent/PRD/requirement.md)与 [`dev-agent/`](../dev-agent/README.md)；
...
[`../dev-agent/rules/constraints.md`](../dev-agent/rules/constraints.md) 的指针」。
...
| 提一个开发请求 | [`../dev-agent/PRD/requirement.md`](../dev-agent/PRD/requirement.md) |
...
| 确认目标产品还要建什么 | [需求](../dev-agent/PRD/requirement.md)与 [`dev-agent/`](../dev-agent/README.md) |
...
旧计划中仍有效的交互目标与 Profile 概念已接收入 [需求](../dev-agent/PRD/requirement.md) 和 `dev-agent/`；
删除旧散文档不删除代码或 Git 历史。
