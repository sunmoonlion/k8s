...
# 从 generate-app/ -> app/ -> custom-values/ -> k8s-resource/ -> resources/ -> auth-app-backend/
...
export AUTH_APP_BFF_IMAGE_REGISTRY="${AUTH_APP_BFF_IMAGE_REGISTRY:-}"
export AUTH_APP_BFF_IMAGE_PROJECT="${AUTH_APP_BFF_IMAGE_PROJECT:-}"
export AUTH_APP_BFF_IMAGE="${AUTH_APP_BFF_IMAGE:-}"
export AUTH_APP_BFF_TAG="${AUTH_APP_BFF_TAG:-}"
...
export AUTH_APP_BFF_IMAGE_PULL_SECRET_NAME="${AUTH_APP_BFF_IMAGE_PULL_SECRET_NAME:-}"
export AUTH_APP_BFF_SECRET_NAME="${AUTH_APP_BFF_SECRET_NAME:-}"
export AUTH_APP_BFF_CONFIGMAP_NAME="${AUTH_APP_BFF_CONFIGMAP_NAME:-}"
