...
```bash
cd /home/zym/k8s/sunmoonai/cicd-platform/jenkins/deploy-jenkins/secrets/kaniko-registry-secret/deploy-kaniko-registry-secret
...
```bash
cd /home/zym/k8s/sunmoonai/cicd-platform/jenkins/deploy-jenkins/secrets/deploy-secrets-all
...
```bash
cd /home/zym/k8s/sunmoonai/cicd-platform/jenkins/deploy-jenkins
