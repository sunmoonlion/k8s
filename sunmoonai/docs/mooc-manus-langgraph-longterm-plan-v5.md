...
2. P0-007A/A2/B/C 已固定 React Router Admin 的完整通用能力与迁移输入；P0-007D 必须
   用 B5 Admin Backend 对其做最终配对闭环，再原子改名为
   `tpl-admin-frontend-react` 并释放 canonical 名称。
