...
# 从 deploy-middleware-all/ -> middleware/ -> deploy-document-converter-backend/ -> document-converter-backend/ -> document-converter-app/
...
deploy_middleware() {
    ...
    local middleware_file="$APP_ROOT/deploy-document-converter-backend/middleware/document-converter-stripprefix.yaml"
