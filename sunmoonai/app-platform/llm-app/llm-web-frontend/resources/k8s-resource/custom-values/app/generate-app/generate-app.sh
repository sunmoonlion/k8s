...
# 从 generate-app/ -> app/ -> custom-values/ -> k8s-resource/ -> resources/ -> llm-web-frontend/
...
export LLM_WEB_FRONTEND_IMAGE_REGISTRY="${LLM_WEB_FRONTEND_IMAGE_REGISTRY:-}"
export LLM_WEB_FRONTEND_IMAGE_PROJECT="${LLM_WEB_FRONTEND_IMAGE_PROJECT:-}"
export LLM_WEB_FRONTEND_IMAGE="${LLM_WEB_FRONTEND_IMAGE:-}"
export LLM_WEB_FRONTEND_TAG="${LLM_WEB_FRONTEND_TAG:-}"
export LLM_WEB_FRONTEND_FULL_IMAGE_NAME="${LLM_WEB_FRONTEND_IMAGE_REGISTRY}/${LLM_WEB_FRONTEND_IMAGE_PROJECT}/${LLM_WEB_FRONTEND_IMAGE}:${LLM_WEB_FRONTEND_TAG}"
export IMAGE_PULL_POLICY="${IMAGE_PULL_POLICY:-}"
export LLM_WEB_FRONTEND_IMAGE_PULL_SECRET_NAME="${LLM_WEB_FRONTEND_IMAGE_PULL_SECRET_NAME:-}"
export LLM_WEB_FRONTEND_SECRET_NAME="${LLM_WEB_FRONTEND_SECRET_NAME:-}"
export LLM_WEB_FRONTEND_CONFIGMAP_NAME="${LLM_WEB_FRONTEND_CONFIGMAP_NAME:-}"
...
# 生成 YAML
main() {
    log_info "开始生成 Llm Web Frontend YAML 文件..."
