...
deploy_app() {
    ...
    apply_deploy_image_registry NODEBULLWORKER_INFO_WEB_BACKEND_IMAGE_REGISTRY
    ...
    log_info "生成并部署 PVC..."
    auto_generate_yaml "$NODEBULLWORKER_INFO_WEB_BACKEND_PVC_YAML" "$K8S_RESOURCE_DIR" || return 1
