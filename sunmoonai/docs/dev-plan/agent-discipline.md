...
同一条逻辑在本文档集内已有先例：`../project-guide/verify.md` §4 要求重写投影时
...
候选清单，结论仍须回代码取证重写（同 `../project-guide/verify.md` §4）。
...
第二条尤其重要：本文档集要求投影自陈盲区（[`../project-guide/verify.md`](../project-guide/verify.md) §1），
**评审同样是一种产出，同样要自陈盲区**。
