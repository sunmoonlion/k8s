...
SECRET_CONFIG="../../deploy-auth-app-backend/secrets/auth-app-backend-secret/deploy-auth-app-backend-secret/deploy-auth-app-backend-secret.conf"
...
export AUTH_APP_BFF_SECRET_NAME="${AUTH_APP_BFF_SECRET_NAME:-auth-app-backend-secret}"
export AUTH_APP_BFF_CONFIGMAP_NAME="${AUTH_APP_BFF_CONFIGMAP_NAME:-auth-app-backend-config}"
...
# 注意：这些变量的默认值在 deploy-auth-app-backend.conf 中配置
export PVC_NAME="${PVC_NAME:-auth-app-backend-pvc}"
