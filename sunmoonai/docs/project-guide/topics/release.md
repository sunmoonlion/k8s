...
> 更新：2026-09-20，本机 KIND 已切换固定开发候选及独立运行身份 ｜ 相关规则见 [`../../tree-build/rules/constraints.md`](../../tree-build/rules/constraints.md)「发布」C-R1–C-R7
...
**动发布、清镜像前**，先读 [`../../tree-build/rules/constraints.md`](../../tree-build/rules/constraints.md)「发布」——本页只写现状。
