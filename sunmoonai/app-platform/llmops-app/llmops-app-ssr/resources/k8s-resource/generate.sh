...
SECRET_CONFIG="../../deploy-llmops-ssr/secrets/llmops-app-ssr-secret/deploy-llmops-app-ssr-secret/deploy-llmops-app-ssr-secret.conf"
...
export LLMOPS_SSR_UNIFIED_HOST="${LLMOPS_SSR_UNIFIED_HOST:-llmops-ssr.sunmoonai.com}"
...
# Ingress 相关变量（用于模板替换）
export SERVICE_NAME="${SERVICE_NAME:-llmops-app-ssr}"
...
# 注意：这些变量的默认值在 deploy-llmops-ssr.conf 中配置
export PVC_NAME="${PVC_NAME:-llmops-app-ssr-pvc}"
