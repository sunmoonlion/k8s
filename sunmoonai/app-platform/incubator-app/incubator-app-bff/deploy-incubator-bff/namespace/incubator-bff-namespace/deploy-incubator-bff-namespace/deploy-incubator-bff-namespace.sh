...
CONFIG_FILE="$SCRIPT_DIR/deploy-incubator-bff-namespace.conf"
# 计算项目根目录（应用根目录）
# 从 deploy-incubator-bff-namespace/ -> incubator-bff-namespace/ -> namespace/ -> deploy-incubator-bff/ -> incubator-app-bff/
PROJECT_ROOT="$(cd "$SCRIPT_DIR/../../../.." && pwd)"

# 使用生成的 YAML 文件（由各组件自己的 generate-*.sh 生成）
K8S_RESOURCE_DIR="$PROJECT_ROOT/resources/k8s-resource"
NAMESPACE_YAML="$K8S_RESOURCE_DIR/custom-values/namespace/incubator-bff-namespace/generate-incubator-bff-namespace/incubator-app-bff-namespace-generated.yaml"
...
# 默认配置从配置文件读取（deploy-incubator-bff-namespace.conf）
...
main() {
  ...
  local generate_script="$PROJECT_ROOT/resources/k8s-resource/custom-values/namespace/incubator-bff-namespace/generate-incubator-bff-namespace/generate-incubator-bff-namespace.sh"
