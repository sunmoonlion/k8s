...
**O1–O6、O10 已了结**（版本口径、RAGFlow CANCEL、RunBudget、Outbox、
Scheduler、citation `source_href`、构建脚本），条目已删，结论分别在：
总览 §9.1、`repos/knowledge-app.md` 与该仓 `test_knowledge_ingestion.py`、
[`README.md`](README.md) 的 U3 行、总览 §9.2、`topics/contracts.md` §5、
`topics/release.md` §2 与 `app-platform/scripts/README.md`。过程见 git 历史。
