...
⚠ 第 3 条是 [§5.2](../SDD/submodules/0001-backend/rules/agent-dev-guide.md) 采信规则与 [§12](../SDD/submodules/0001-backend/rules/0004-acceptance-commit-notes.md) 三级证据分档的**前提**：分不清事实与推断，
后面两处的分级就无从谈起。
...
| 20b | **`llm-review` 能否用于任何 `auto_policy = 无` 的权力表行** | 未决。[§4.7](../SDD/submodules/0001-backend/rules/0003-interrupt-resume-notes.md) 立了四档审批，但 `llm-review` 不是 principal 的权力，在 [§4.2](../SDD/submodules/0001-backend/rules/agent-dev-guide.md) 权力表里没有行。⚠ **本文不裁**——它要么是 H 行的一个前置过滤器，要么根本不该出现在需人批准的路径上，两种读法后果不同 |
...
| 内核用语 | 本文对应物 |
| --- | --- |
| Submission | 原始请求来源；人直接提出时由人冻结请求与验收（[§3.1](../SDD/submodules/0001-backend/rules/0001-intake-notes.md)） |
...
| Artifact | 代码、补丁、报告、测试输出、证据（[§3.6](../SDD/submodules/0001-backend/rules/0002-agent-execution-notes.md)） |
| Interaction | 向 principal 的澄清或批准请求（[§4.3](../SDD/submodules/0001-backend/rules/0003-interrupt-resume-notes.md)） |
| Event | 只追加的事实记录，状态由其投影；可包含改判与证据引用（[§5.7](../SDD/submodules/0001-backend/rules/0004-acceptance-commit-notes.md)） |
...
| harness / executor adapter | 执行外壳（程序、提示词、工具）/ 将其公开 SDK 接到统一 Port 的适配层（[§2.6](../SDD/submodules/0001-backend/rules/0002-agent-execution-notes.md)–[§2.8](../SDD/submodules/0001-backend/rules/0002-agent-execution-notes.md)） |
...
| 人的主 checkout | 如 `~/master/<仓>`；**只读参照，不是投稿箱**（[§3.6](../SDD/submodules/0001-backend/rules/0002-agent-execution-notes.md)） |
| Attempt 租约 / fencing | **产品侧机制**，语义见内核；**开发侧无等价运行时**，迟到判定靠冻结 commit 与整合方核对（[§3.9](../SDD/submodules/0001-backend/rules/0002-agent-execution-notes.md)） |
