...
```text
thread/                           一串 turn；目录名为「本地号-执行环境 id」，带任务书 user-message.md、回执 turn.md 与交回物
...
| 每次派工的任务书 | 各 turn 的 `user-message.md`，如 [`thread/0001-none/user-message.md`](thread/0001-none/user-message.md) |
