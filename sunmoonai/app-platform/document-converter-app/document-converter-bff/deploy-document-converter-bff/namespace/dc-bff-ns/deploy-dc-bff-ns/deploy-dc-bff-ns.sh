...
CONFIG_FILE="$SCRIPT_DIR/deploy-dc-bff-ns.conf"
# 计算项目根目录（应用根目录）
...
NAMESPACE_YAML="$K8S_RESOURCE_DIR/custom-values/namespace/dc-bff-ns/generate-dc-bff-ns/document-converter-bff-namespace-generated.yaml"
...
main() {
  ...
  local generate_script="$PROJECT_ROOT/resources/k8s-resource/custom-values/namespace/dc-bff-ns/generate-dc-bff-ns/generate-dc-bff-ns.sh"
