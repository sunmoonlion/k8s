...
# 从 generate-harbor-registry-secret/ -> harbor-registry-secret/ -> secret/ -> custom-values/ -> k8s-resource/ -> resources/ -> celeryworker-incubator/
...
export HARBOR_REGISTRY_URL="${HARBOR_REGISTRY_URL:-}"
export HARBOR_REGISTRY_USERNAME="${HARBOR_REGISTRY_USERNAME:-}"
export HARBOR_REGISTRY_PASSWORD="${HARBOR_REGISTRY_PASSWORD:-}"
