...
# =============================================================================
# Harbor Registry Secret 部署脚本（Llm Web Backend）
...
# deploy-harbor-registry-secret/ -> harbor-registry-secret/ -> secret/ -> deploy-llm-web-backend/ -> llm-web-backend/
...
main() {
    ...
    log_info "部署 Harbor Registry Secret (Llm Web Backend)..."
    log_info "部署参数："
    log_info "  - 操作: $action"
    ...
    echo ""
    log_success "Harbor Registry Secret (Llm Web Backend) 操作完成！"
    log_info "操作信息："
    log_info "  - 操作: $action"
...
# 显示帮助信息
show_help() {
    echo "Harbor Registry Secret 部署脚本 (Llm Web Backend)"
    echo ""
    echo "用法:"
