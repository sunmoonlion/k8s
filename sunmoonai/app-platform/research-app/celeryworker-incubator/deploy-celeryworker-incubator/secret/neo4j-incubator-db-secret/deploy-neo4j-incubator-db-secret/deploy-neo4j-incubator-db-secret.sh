...
SECRET_YAML="$K8S_RESOURCE_DIR/custom-values/secret/neo4j-incubator-db-secret/generate-neo4j-incubator-db-secret/neo4j-incubator-db-secret-generated.yaml"
...
auto_generate_yaml() {
    ...
    if [ ! -f "$yaml_file" ]; then
        ...
        local generate_script="$k8s_resource_dir/custom-values/secret/neo4j-incubator-db-secret/generate-neo4j-incubator-db-secret/generate-neo4j-incubator-db-secret.sh"
