...
def main() -> int:
    ...
    candidate_renderer = k8s_root / "sunmoonai/docs/architecture-v2/scripts/render_r5_knowledge_candidate.py"
    ...
    release = {
        ...
        "legacy_deployments": ["knowledge-admin-backend", "celeryworker-knowledge-admin-backend"],
        "external_secrets": [
