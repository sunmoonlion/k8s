...
APPLICATION="sunmoonai-research-web-p0-009d"
REDIRECT_URI="https://research-web-p0-009d.sunmoonai.com:30443/api/auth/callback"
MODE="plan"
...
[[ "$REDIRECT_URI" =~ ^https://research-web-p0-009d\.sunmoonai\.com(:[0-9]+)?/api/auth/callback$ ]] || {
