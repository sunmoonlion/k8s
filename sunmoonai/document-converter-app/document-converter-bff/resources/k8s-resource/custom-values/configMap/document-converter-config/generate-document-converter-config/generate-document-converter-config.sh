...
CONFIG_FILE="$SCRIPT_DIR/generate-document-converter-config.conf"
...
# 从 generate-document-converter-config/ -> document-converter-config/ -> configMap/ -> custom-values/ -> k8s-resource/ -> resources/ -> document-converter-bff/
