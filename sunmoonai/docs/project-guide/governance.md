...
- **规则**（[`../dev-agent/composition/constraints.md`](../dev-agent/rules/constraints.md)）是**必须遵守的**，
...
| 必须遵守的规则 | [`../dev-agent/composition/constraints.md`](../dev-agent/rules/constraints.md) |
