#!/bin/bash
# research-admin-frontend Namespace YAML 生成脚本

set -euo pipefail

SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
CONFIG_FILE="$SCRIPT_DIR/generate-research-admin-frontend-namespace.conf"
...
main() {
    log_info "开始生成 research-admin-frontend Namespace YAML 文件..."
