...
平台只建设一个产品运行时。它以
[`product-contract.md`](../PRD/product-contract.md) 定义的 Task、Attempt、Interaction、Artifact、
...
| 真源 | 本文怎样使用 | 本文不做什么 |
| --- | --- | --- |
| [`product-contract.md`](../PRD/product-contract.md) | 引用七对象、Task/Attempt 状态机、`I1`–`I15`、`F-*`、`AT-*` | 不重写对象定义、合法边或产品验收矩阵 |
