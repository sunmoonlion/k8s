...
| B7 已有覆盖收口 | B7a～B7e 源码已集成；其余未完成 | [子项矩阵](v5-backlog-coverage-luna.md)；[Worker 消费配置检查](v5-backlog-worker-readiness-luna.md)。已定位并修复本机双重校时冲突，四仓原始完整门禁 1205 项零跳过；采集/告警、消费进展、Scheduler、保留归档及实际环境门禁继续；接 B4～B6 运维/切换，自动修复回收与全引用门禁交 N4 |
