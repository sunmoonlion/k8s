#!/bin/bash
# toutiao-app-backend App YAML 生成脚本
...
# 从 generate-app/ -> app/ -> custom-values/ -> k8s-resource/ -> resources/ -> toutiao-app-backend/
...
export ENV="${ENV:-}"
export TOUTIAO_BACKEND_IMAGE_REGISTRY="${TOUTIAO_BACKEND_IMAGE_REGISTRY:-}"
export TOUTIAO_BACKEND_IMAGE_PROJECT="${TOUTIAO_BACKEND_IMAGE_PROJECT:-}"
export TOUTIAO_BACKEND_IMAGE="${TOUTIAO_BACKEND_IMAGE:-}"
export TOUTIAO_BACKEND_TAG="${TOUTIAO_BACKEND_TAG:-}"
export TOUTIAO_BACKEND_FULL_IMAGE_NAME="${TOUTIAO_BACKEND_IMAGE_REGISTRY}/${TOUTIAO_BACKEND_IMAGE_PROJECT}/${TOUTIAO_BACKEND_IMAGE}:${TOUTIAO_BACKEND_TAG}"
export IMAGE_PULL_POLICY="${IMAGE_PULL_POLICY:-}"
export TOUTIAO_BACKEND_IMAGE_PULL_SECRET_NAME="${TOUTIAO_BACKEND_IMAGE_PULL_SECRET_NAME:-}"
export TOUTIAO_BACKEND_SECRET_NAME="${TOUTIAO_BACKEND_SECRET_NAME:-}"
export TOUTIAO_BACKEND_CONFIGMAP_NAME="${TOUTIAO_BACKEND_CONFIGMAP_NAME:-}"
...
main() {
    log_info "开始生成 toutiao-app-backend App YAML..."
