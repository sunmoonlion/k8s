...
load_config() {
    ...
    # 主配置文件路径：../../deploy-incubator-bff.conf（相对于当前脚本目录）
    local main_config_file="$(cd "$SCRIPT_DIR/../.." && pwd)/deploy-incubator-bff.conf"
  ...
  NAMESPACE="${INCUBATOR_BFF_NAMESPACE:-app-platform-dev}"
  UNIFIED_HOST="${INCUBATOR_BFF_UNIFIED_HOST:-incubator.sunmoonai.com}"
  NODE_IP="${INCUBATOR_BFF_NODE_IP:-101.126.151.0}"
  EXTERNAL_PORT="${INCUBATOR_BFF_EXTERNAL_PORT:-30443}"
