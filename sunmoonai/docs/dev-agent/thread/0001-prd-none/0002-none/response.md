...
| 仓库、组件、运行角色 | [拓扑](#拓扑) |
| 部署、发版、镜像 | [发布](#发布) |
| 智能体 | [智能体](#智能体) + [`competition-protocol.md`](../../composition/protocol/competition-protocol.md) |
...
| A2 | **两边都要有纪律**，不存在"通用部分不需要约束" | [`competition-protocol.md`](../../composition/protocol/competition-protocol.md) |
...
> 依据的通用规范：[UAT 规则「规则要有载体」](../../../dev-agent-standards/uat/uat-rules.md)
