...
APPLICATION="sunmoonai-info-web-p0-009b"
REDIRECT_URI="https://info-web-p0-009b.sunmoonai.com:30443/api/auth/callback"
MODE="plan"
...
[[ "$REDIRECT_URI" =~ ^https://info-web-p0-009b\.sunmoonai\.com(:[0-9]+)?/api/auth/callback$ ]] || {
