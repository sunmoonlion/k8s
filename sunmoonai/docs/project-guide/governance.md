...
> 提请求 → [`../dev-agent-task/composition/product-contract.md`](../dev-agent-task/composition/product-contract.md)；
...
| 内容 | 去哪 |
| --- | --- |
| 将来要做什么、应该怎样 | 请求记录（见 [`../dev-agent-task/composition/product-contract.md`](../dev-agent-task/composition/product-contract.md)） |
