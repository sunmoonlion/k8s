...
CONFIG_FILE="$SCRIPT_DIR/deploy-cw-llm-ns.conf"
# 计算项目根目录（应用根目录）
...
NAMESPACE_YAML="$K8S_RESOURCE_DIR/custom-values/namespace/cw-llm-ns/generate-cw-llm-ns/celeryworker-llmops-namespace-generated.yaml"
...
main() {
  ...
  local generate_script="$PROJECT_ROOT/resources/k8s-resource/custom-values/namespace/cw-llm-ns/generate-cw-llm-ns/generate-cw-llm-ns.sh"
