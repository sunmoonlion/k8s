...
> 取证时点：2026-09-13 后端接线复核；本次不改契约 ｜ 相关规则见 [`../../dev-investment-agent/tree-build/rules/constraints.md`](../../dev-investment-agent/tree-build/rules/constraints.md)「契约」C-C1–C-C6
