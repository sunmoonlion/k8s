...
```bash
cd ~/k8s/sunmoonai/document-converter-app/document-converter-backend/resources/source
...
```bash
cd ~/k8s/sunmoonai/document-converter-app/document-converter-backend/deploy-document-converter-backend/app/deploy-app
