...
- 状态：IN_PROGRESS（2026-07-14：已创建并记录迁移前 tag `p0-007b-info-admin-vue-baseline-20260714`，冻结 Vue commit、父仓指针、当前镜像 tag/digest 和运行 Pod；React 业务竖切本地提交为 Info `e34c1774480da8acd27b60a57e8a35f0c130912a`、父仓 `e297396985d57fa766b52f073de95a9463b7722b`，typecheck/lint/test 已通过，尚待 Docker/build、隔离 Deployment/Ingress 和真实后端 E2E；不得切正式流量）
