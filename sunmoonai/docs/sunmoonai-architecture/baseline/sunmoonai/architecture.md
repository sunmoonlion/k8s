...
[App Platform 架构](../app-platform/app-platform-architecture/架构.md)。
...
[App Platform 架构](../app-platform/app-platform-architecture/架构.md) §2–§3、§10。
...
模板同步顺序与实例边界见 [App Platform 架构](../app-platform/app-platform-architecture/架构.md) §10。
...
[App Platform 架构](../app-platform/app-platform-architecture/架构.md) §12。
