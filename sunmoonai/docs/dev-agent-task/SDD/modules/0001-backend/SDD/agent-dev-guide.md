...
角色分离以 competition-protocol“⑤ 验收 与 ⑥ 确认”为准，本文 [§3.19](../../../../protocol/competition-operations.md) 给出操作算法。
...
产物命名、候选冻结、处置表和验收方算法见 [§3.19](../../../../protocol/competition-operations.md)–[§3.22](modules/0002-agent-execution/SDD/agent-dev-guide.md)，来源为现行 competition-protocol。状态脚本从 commit 反推，工作区
